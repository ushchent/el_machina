...
Целевой признак - status, принимает значения 1 или 0. Поле status нужно заполнить для набора test.csv до 18 ноября 2019 года, когда ЦК по выборам начнет объявлять результаты.
